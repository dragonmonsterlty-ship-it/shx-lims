...
export const experiments: Experiment[] = [
  { id: 601, project_id: 101, experiment_no: 'EXP-A-001', title: 'A-001 强制降解试验', lead_user_id: 4, participant_ids: [5], status: 'completed', plan_start_date: day(-20), plan_end_date: day(-10), objective: '考察 A-001 在酸碱氧化条件下的稳定性。', steps: '1. 配制酸/碱/氧化体系；\n2. 分别放置取样；\n3. HPLC 监测降解产物。', result_summary: '氧化条件下产生主要降解杂质，含量下降约 3%。', is_deleted: false, ...audit(4) },
  ...
  { id: 603, project_id: 101, experiment_no: 'EXP-A-003', title: 'A 留样观察', lead_user_id: 5, participant_ids: [4], status: 'planned', plan_start_date: day(2), plan_end_date: day(12), objective: '长期留样外观与含量观察。', steps: '按月取样检测。', result_summary: '', is_deleted: false, ...audit(3) },
  ...
  { id: 605, project_id: 102, experiment_no: 'EXP-B-002', title: 'B 含量复核', lead_user_id: 4, participant_ids: [], status: 'completed', plan_start_date: day(-15), plan_end_date: day(-8), objective: '复核 B 原料药含量。', steps: '平行双样测定。', result_summary: '两份结果一致，含量 99.8%。', is_deleted: false, ...audit(2) },
  ...
  { id: 607, project_id: 103, experiment_no: 'EXP-C-002', title: 'C 杂质归属', lead_user_id: 5, participant_ids: [], status: 'cancelled', plan_start_date: day(-25), plan_end_date: day(-18), objective: '未知杂质结构归属。', steps: 'LCMS 分析。', result_summary: '因样品不足取消。', is_deleted: false, ...audit(1) },
  { id: 608, project_id: 104, experiment_no: 'EXP-D-001', title: 'D 路线 A 小试', lead_user_id: 3, participant_ids: [4, 5], status: 'completed', plan_start_date: day(-40), plan_end_date: day(-20), objective: '验证小试合成路线 A 的可行性。', steps: '三步法合成并纯化。', result_summary: '路线可行，总收率 42%。', is_deleted: false, ...audit(3) },
